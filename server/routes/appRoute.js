...
const { getAllTour,CrateTour, deleteAlltour, SingleTourDelete, SingelTour, getTourByUser, Cloud, updateTourData } = require('../controller/tour');
...
router.route('/update/:id').get(updateTourData);
